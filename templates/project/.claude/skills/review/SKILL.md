---
name: review
description: Use when Claude Code is asked to review, audit, check, critique, validate, or inspect code or changes, especially changes made by another agent. Inspect actual diff and evidence instead of trusting summaries.
---
