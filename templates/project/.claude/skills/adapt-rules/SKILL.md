---
name: adapt-rules
description: Use when Claude Code is asked to install, bootstrap, adapt, migrate, or initialize Rules for this project, especially when .agent/adaptation-review.md is pending. The agent must inspect current code/config and write verified project-specific rules.
---
