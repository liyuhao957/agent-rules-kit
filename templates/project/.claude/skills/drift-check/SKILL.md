---
name: drift-check
description: Use when Claude Code needs to determine whether current code/config changes may require updates to AGENTS, CLAUDE, .agent docs, skills, hooks, or shared project rules. Runs the doc drift detector and interprets the result.
---
