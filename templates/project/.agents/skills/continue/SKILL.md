---
name: continue
description: Use when Codex is continuing unfinished work from Claude, another Codex session, a human, or a previous handoff. Reconstruct state from current files and git before proceeding.
---
