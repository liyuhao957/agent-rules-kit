...
- **Installed before, new version out** — add `--upgrade`. Only the bundled scripts, hooks, skills, and workflow docs are updated; the project facts you filled in are not touched, and replaced files are backed up first.
